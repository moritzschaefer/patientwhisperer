...
#
# Prerequisite: infusion_atlas.h5ad must exist (run scripts/run_compute_embeddings.sh first)
#
# Submit:
#   ssh ilc 'sbatch /sailhome/moritzs/patientwhisperer/experiments/agent_lbcl_bench_with_spatial/scripts/run_step3_gene_expr_snap.sh'
set -e
